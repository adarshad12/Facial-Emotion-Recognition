...
X_train, X_validation, y_train, y_validation = train_test_split(X, Y_, test_size = 0.2, random_state=45)
...
train_data = data_aug.flow(X_train, y_train, batch_size=50)
validation_data = data_aug.flow(X_validation, y_validation, batch_size=32)



vgg_model = ResNet50(input_shape = (48,48,3), include_top = False, weights = 'imagenet')
...
model.save('./predict_ResNet50.h5')
